...
public class AdministradorWebServiceActivity extends ListActivity {

    String[] menu ={"Insertar", "Consultar"};
    String[] activities={"AdministradorInsertarWSActivity", "AdministradorConsultarWSActivity"};
