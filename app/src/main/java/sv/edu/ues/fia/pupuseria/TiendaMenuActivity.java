...
public class TiendaMenuActivity extends ListActivity {

    String[] menu ={"Insertar", "Actualizar", "Consultar", "Eliminar"};
    String[] activities={"TiendaInsertarActivity", "TiendaActualizarActivity",
            "TiendaConsultarActivity", "TiendaEliminarActivity"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //setContentView(R.layout.activity_tienda_menu);
